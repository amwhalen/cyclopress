	...
	if ($_POST['submitted']) {
		...
		<div class="wrap">
			...
			<table class="widefat">
				...
				<thead>
					<tr>
						<th><a href="?page=cyclopress/cyclopress.php&cy_sort_col=date&cy_sort=<?php if ($sort_col=='date') { if ($sort_order=='desc') { echo 'asc'; } else { echo 'desc'; } } else  { echo 'desc'; } ?>" class="cy_sort">Date<?php if ($sort_col=='date') { if ($sort_order=='desc') { echo ' &darr;'; } else { echo ' &uarr;'; } } ?></a></th>
						<th><a href="?page=cyclopress/cyclopress.php&cy_sort_col=distance&cy_sort=<?php if ($sort_col=='distance') { if ($sort_order=='desc') { echo 'asc'; } else { echo 'desc'; } } else  { echo 'desc'; } ?>" class="cy_sort">Distance<?php if ($sort_col=='distance') { if ($sort_order=='desc') { echo ' &darr;'; } else { echo ' &uarr;'; } } ?></a></th>
						...
						<th><a href="?page=cyclopress/cyclopress.php&cy_sort_col=time&cy_sort=<?php if ($sort_col=='time') { if ($sort_order=='desc') { echo 'asc'; } else { echo 'desc'; } } else  { echo 'desc'; } ?>" class="cy_sort">Time<?php if ($sort_col=='time') { if ($sort_order=='desc') { echo ' &darr;'; } else { echo ' &uarr;'; } } ?></a></th>
						<th>Notes</th>
					</tr>
				</thead>
